...
from datetime import datetime, timezone as datetime_tz, timedelta
...
class TimeZone:
    ...
    def get_TZ(self) -> datetime_tz:
        """获取时区信息"""
        utc_offset = self.tz_info.utcoffset(datetime.now())
        return datetime_tz(utc_offset if utc_offset else timedelta(hours=0))
...
if __name__ == "__main__":
    ...
    TZ_8 = datetime_tz(timedelta(hours=8))
    print(timezone.get_TZ())
    print("========")
    print(type(timezone.get_TZ()))